...
extension UIView {
  ...
  animate(withDuration: duration,
            animations: animations) { (animationCompleted) in
...
UIView.animate(withDuration: 4,
                 animations: {
                                ...
                                print("Sub Animations Completed!")
}
...
//  // Change background color to blue
//  view.backgroundColor = UIColor.blue
//    print("Sub chnage to blue Animations Completed!")
//
//})
//
...
//  //https://stackoverflow.com/questions/31451965/waiting-for-both-completed-tasks-in-ios-when-one-of-them-is-animation
